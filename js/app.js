...
document.querySelectorAll('.hamburger, nav ul li a').forEach(item => {
...
window.addEventListener('resize', handleExpandedHeader);
  //------------------------------------------------------------------------//
...
// Add an event listener to close the suggestions when clicking outside the search bar
document.addEventListener('click', function (event) {
